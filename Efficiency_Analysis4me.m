...
e = ODDBALL.new('Mixed47', 'abba');

for k=1:nsim
    test_set{1,k} = ODDBALL.new('Mixed47', 'abba')
end
...
for j=1:nsim
    ...
    r1=zeros(1, 7201);  %we are creating a vector of zeros of total_lenght * 4 TRs (8*900 = 7200)
